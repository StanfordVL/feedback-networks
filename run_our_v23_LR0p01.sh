...
th main.lua -nGPU 1 -depth 20 -batchSize 128 -dataset cifar100 -nEpochs 100 -netType 'our_v23' -save 'checkpoints_our_v23_cond5_LR0p01' -resume 'checkpoints_our_v23_cond4' -LR 0.01 2>&1 | tee log_our_v23_cond5_LR0p01.txt
