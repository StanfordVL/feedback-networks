...
local ConvLSTM, parent = torch.class('nn.ConvLSTM_resnetX2_2', 'nn.LSTM')
...
function ConvLSTM:buildGate()
   ...
   :add(nn.ReLU(true))
   :add(nn.SpatialConvolution(self.outputSize, self.outputSize, self.kc, self.kc, 1, 1, self.padc, self.padc))
   :add(nn.SpatialBatchNormalization(self.outputSize, 1e-3))
