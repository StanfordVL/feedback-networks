...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(Convolution(3,84,3,3,1,1,1,1))
      model:add(SBatchNorm(84))
      model:add(ReLU(true))

      model:add(Convolution(84,168,3,3,2,2,1,1))
      model:add(SBatchNorm(168))
      model:add(ReLU(true))
      model:add(Convolution(168,168,3,3,1,1,1,1))
      model:add(SBatchNorm(168))
      
      model:add(Convolution(168,336,3,3,2,2,1,1))
      model:add(SBatchNorm(336))
      model:add(ReLU(true))
      model:add(Convolution(336,336,3,3,1,1,1,1))
      model:add(SBatchNorm(336))

      model:add(Avg(8, 8, 1, 1))
      model:add(nn.View(336):setNumInputDims(3))
      model:add(nn.Linear(336, 100))
   else
