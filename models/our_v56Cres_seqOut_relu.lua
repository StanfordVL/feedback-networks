...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(nn.Sequencer(nn.ConvLSTM_bn2(19, 38, T, 3, 3, 2, N/opt.nGPU)))
      model:add(nn.Sequencer(nn.ConvLSTM_bn2(38, 38, T, 3, 3, 1, N/opt.nGPU)))
      model:add(nn.Sequencer(nn.ConvLSTM_bn2(38, 76, T, 3, 3, 2, N/opt.nGPU)))
      model:add(nn.Sequencer(nn.ConvLSTM_bn2(76, 76, T, 3, 3, 1, N/opt.nGPU)))
      model:add(nn.Sequencer(nn.ReLU(true)))

      model:add(nn.Sequencer(Avg(8, 8, 1, 1)))
      model:add(nn.Sequencer(nn.View(76):setNumInputDims(3)))
      model:add(nn.Sequencer(nn.Linear(76, 100)))
   else
