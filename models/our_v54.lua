...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(nn.Sequencer(nn.ConvLSTM_bottleneck5(16, 64,   T, 3, 3, 2, N/opt.nGPU)))
      model:add(nn.Sequencer(nn.ConvLSTM_bottleneck5(64, 64,   T, 3, 3, 1, N/opt.nGPU)))
      model:add(nn.Sequencer(nn.ConvLSTM_bottleneck5(64, 256,  T, 3, 3, 2, N/opt.nGPU)))
      model:add(nn.Sequencer(nn.ConvLSTM_bottleneck5(256, 256, T, 3, 3, 1, N/opt.nGPU)))
