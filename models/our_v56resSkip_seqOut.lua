...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(nn.Sequencer(nn.ConvLSTM_bn3resSkip(16, 16, T, 3, 3, 1, N/opt.nGPU)))
      -- model:add(nn.Sequencer(nn.ReLU(true)))
      model:add(nn.Sequencer(nn.ConvLSTM_bn3resSkip(16, 32, T, 3, 3, 2, N/opt.nGPU)))
      -- model:add(nn.Sequencer(nn.ReLU(true)))
      model:add(nn.Sequencer(nn.ConvLSTM_bn3resSkip(32, 64, T, 3, 3, 2, N/opt.nGPU)))
      -- model:add(nn.Sequencer(nn.ReLU(true)))
      model:add(nn.Sequencer(nn.ConvLSTM_bn3resSkip(64, 64, T, 3, 3, 1, N/opt.nGPU)))
      -- model:add(nn.Sequencer(nn.ReLU(true)))
