...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(nn.Sequencer(nn.ConvLSTM_bn_slim4(32, 64,  T, 3, 3, 2, N/opt.nGPU)))
      -- model:add(nn.Sequencer(nn.ReLU(true)))
      model:add(nn.Sequencer(nn.ConvLSTM_bn_slim4(64, 128, T, 3, 3, 2, N/opt.nGPU)))
      -- model:add(nn.Sequencer(nn.ReLU(true)))
