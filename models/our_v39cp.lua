...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      -- model:add(nn.Sequencer(ReLU(true)))
      model:add(nn.Sequencer(nn.ConvLSTM_resnet4(64, 128, T, 3, 3, 2, N/opt.nGPU)))
      ...
      model:add(nn.Sequencer(nn.View(128):setNumInputDims(3)))
      model:add(nn.Sequencer(nn.Linear(128, 100)))
   else
