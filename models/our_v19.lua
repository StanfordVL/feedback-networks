...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(nn.Sequencer(nn.ConvLSTM_resnet(96, 96, T, 3, 3, 1, N/opt.nGPU)))
      ...
      model:add(nn.View(T, -1, 96, 8, 8))
      model:add(nn.Mean(1))
      model:add(nn.Squeeze(1))

      -- model:add(Avg(8, 8, 1, 1))
      model:add(nn.View(6144):setNumInputDims(3))
      model:add(nn.Linear(6144, 100))
