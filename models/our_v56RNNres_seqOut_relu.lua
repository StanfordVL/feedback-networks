...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(nn.Sequencer(nn.ConvRNN3res(16, 16, T, 3, 3, 32, 1)))
      model:add(nn.Sequencer(nn.ConvRNN3res(16, 32, T, 3, 3, 16, 2)))
      model:add(nn.Sequencer(nn.ConvRNN3res(32, 64, T, 3, 3, 8,  2)))
      model:add(nn.Sequencer(nn.ConvRNN3res(64, 64, T, 3, 3, 8,  1)))
