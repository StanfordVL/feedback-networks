...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(ReLU(true))
      model:add(Convolution(32,64,3,3,2,2,1,1))
      model:add(SBatchNorm(64))
      model:add(ReLU(true))
      ...
      model:add(nn.Sequencer(nn.ConvLSTM_resnet(64, 64, T, 3, 3, 1, N/opt.nGPU)))

      -- model:add(nn.Sequencer(Convolution(64,64,1,1,2,2)))
      model:add(nn.Sequencer(Avg(1,1,2,2)))
