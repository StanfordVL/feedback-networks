...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(nn.Sequencer(nn.ConvLSTM_resnet5afc(16, 32, T, 3, 3, 2, N/opt.nGPU)))
      model:add(nn.Sequencer(nn.ConvLSTM_resnet5afc(32, 32, T, 3, 3, 1, N/opt.nGPU)))
      model:add(nn.Sequencer(nn.ConvLSTM_resnet5afc(32, 64, T, 3, 3, 2, N/opt.nGPU)))
      model:add(nn.Sequencer(nn.ConvLSTM_resnet5afc(64, 64, T, 3, 3, 1, N/opt.nGPU)))
