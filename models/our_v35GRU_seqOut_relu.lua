...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(nn.Sequencer(nn.ConvGRU2(16, 32, T, 3, 3, 16, 2, 0.00)))
      model:add(nn.Sequencer(nn.ConvGRU2(32, 32, T, 3, 3, 16, 1, 0.00)))
      model:add(nn.Sequencer(nn.ConvGRU2(32, 64, T, 3, 3, 8,  2, 0.00)))
      model:add(nn.Sequencer(nn.ConvGRU2(64, 64, T, 3, 3, 8,  1, 0.00)))
