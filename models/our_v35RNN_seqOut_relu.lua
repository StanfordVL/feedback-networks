...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(nn.Sequencer(nn.ConvRNN2(16, 32, T, 3, 3, 16, 2)))
      model:add(nn.Sequencer(nn.ConvRNN2(32, 32, T, 3, 3, 16, 1)))
      model:add(nn.Sequencer(nn.ConvRNN2(32, 64, T, 3, 3, 8,  2)))
      model:add(nn.Sequencer(nn.ConvRNN2(64, 64, T, 3, 3, 8,  1)))
