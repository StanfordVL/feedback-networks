...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      model:add(nn.Sequencer(layer(basicblock, 32, 1, 2)))
      model:add(nn.Sequencer(nn.ConvLSTM_resnet2(32, 32, T, 3, 3, 1, N/opt.nGPU)))
      model:add(nn.Sequencer(layer(basicblock, 64, 1, 2)))
      model:add(nn.Sequencer(nn.ConvLSTM_resnet2(64, 64, T, 3, 3, 1, N/opt.nGPU)))
