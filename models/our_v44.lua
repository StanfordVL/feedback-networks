...
local function createModel(opt)
   ...
   elseif opt.dataset == 'cifar100' then
      ...
      local s1 = nn.ConvLSTM_resnet5(16, 32, T, 3, 3, 2, N/opt.nGPU)
      local s2 = nn.ConvLSTM_resnet5(32, 64, T, 3, 3, 2, N/opt.nGPU)
      ...
      --model:add(nn.Sequencer(rnnSkip2))
      model:add(nn.Sequencer(nn.ConvLSTM_resnet5(32, 32, T, 3, 3, 2, N/opt.nGPU)))
